...
## just the LTR - for Phylogeny
for i in assemblies-Droso/*.fa; do RepeatMasker -pa 20 -no_is -s -nolow -dir rm/Droso-ltr -lib seq/spoink-dmel-LTR_v1.fasta $i;done 
```
...
cat Droso.sum | grep -v "D.mel.RAL91\|D.mel.RAL732\|D.sim.SZ*\|D.mau.R39\|D.mau.R31\|D.mau.R32\|D.mau.R61\|D.mel.Pi2\|D.mel.Es_Ten\|D.mel.RAL176\|D.mel.SE_Sto" > Droso.subset2.sum
python ../score-max.py --rm Droso.subset.sum >Droso.subset.score
python ../score-max.py --rm Droso.subset2.sum >Droso.subset2.score
...
h<-read.table("/Users/rokofler/analysis/2023-Spoink/Dmel-Spoink/2023-09-originOfSpoink/raw/Droso.subset2.score",header=F)
